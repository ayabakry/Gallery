...
import fr1 from '../Imgs/fr1.png';
import fr2 from '../Imgs/fr2.png';
import fr3 from '../Imgs/fr3.png';
                ...
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card" style={{ border: '0 solid whitesmoke', backgroundColor: '#eeeeee' }}>
                            ...
                            <img src={fr1} className="card-img-top" alt="..." style={{ backgroundColor: '#f1d4a1' }} />
                            <div className="card-body">
                                <h5 class="card-title" style={{color: '#0f6f9b'}}>Friends don’t let friends do silly things alone.
                    ...
                    <div className="col">
                        <div className="card" style={{ border: '0 solid whitesmoke', backgroundColor: '#eeeeee' }}>
                            <img src={fr2} className="card-img-top" alt="..." style={{ backgroundColor: 'rgb(184 141 92 / 47%)' }} />

                            <div className="card-body">
                                <h5 class="card-title" style={{color: '#0f6f9b'}}>Life was meant for best friends and good adventures!
                                    <label className="add-fav" style={{ textAlign: 'right', display: 'block ' }} >
                                        <input type="checkbox" />
                                        <span className="icon-heart" style={{ fontSize: '35px' }}><FaRegHeart />
                    ...
                    <div className="col">
                        <div className="card" style={{ border: '0 solid whitesmoke', backgroundColor: '#eeeeee' }} >
                            ...
                            <img src={fr3} className="card-img-top" alt="..." style={{ backgroundColor: '#5e93ac' }} />

                            <div className="card-body">
                            <h5 class="card-title" style={{color: '#0f6f9b'}}>I don’t know what I did to deserve a best friend like you.
                                    <label className="add-fav" style={{ textAlign: 'right', display: 'block ' }} >
                                        <input type="checkbox" />
                                        <span className="icon-heart" style={{ fontSize: '35px' }}><FaRegHeart />
