...
import lv1 from '../Imgs/lv1.png';
import lv2 from '../Imgs/lv2.png';
import lv3 from '../Imgs/lv3.png';
                ...
                <div className="row row-cols-1 row-cols-md-3 g-4">
                    <div className="col">
                        <div className="card" style={{ border: '0 solid whitesmoke', backgroundColor: '#eeeeee' }}>
                                ...
                                <img src={lv1} className="card-img-top" alt="..." style={{ backgroundColor: '#f1d4a1' }} />
                            <div className="card-body">
                            <h5 class="card-title" style={{color: '#0f6f9b'}}>If I know what love is, it is because of you.
                    ...
                    <div className="col">
                        <div className="card" style={{ border: '0 solid whitesmoke', backgroundColor: '#eeeeee' }}>
                                <img src={lv2} className="card-img-top" alt="..." style={{ backgroundColor: 'rgb(184 141 92 / 47%)' }} />
                    ...
                    <div className="col">
                        <div className="card" style={{ border: '0 solid whitesmoke', backgroundColor: '#eeeeee' }} >
                                ...
                                <img src={lv3} className="card-img-top" alt="..." style={{ backgroundColor: '#5e93ac' }} />
                          
                            <div className="card-body">
                            <h5 class="card-title" style={{color: '#0f6f9b'}}>You make me want to be a better man.
                                    <label className="add-fav" style={{ textAlign: 'right', display: 'block ' }} >
                                        <input type="checkbox" />
                                        <span className="icon-heart" style={{ fontSize: '35px' }}><FaRegHeart />
